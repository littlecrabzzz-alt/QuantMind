#!/usr/bin/env python3
"""Plan or execute one hash-pinned index-weight history batch."""
...
from scripts import prepare_tushare_index_weight_batch as preparation  # noqa: E402
    ...
    *,
    ...
    if not execute:
        ...
        return {
            ...
            "verified_jobs": len(verified["records"]),
            "api_counts": {preparation.API: len(verified["records"])},
            "selected": verified["selected"],
            "boundaries": verified["boundaries"],
            "max_upstream_calls": max_requests,
            "max_seconds": max_seconds,
