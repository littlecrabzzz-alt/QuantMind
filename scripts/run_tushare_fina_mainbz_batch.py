#!/usr/bin/env python3
"""Plan or execute one hash-pinned fina_mainbz history batch."""
...
from scripts import prepare_tushare_fina_mainbz_batch as preparation  # noqa: E402
        ...
        with ExitStack() as guards:
            for target in (
                ...
                guards.enter_context(
                    patch(
                        target,
                        side_effect=AssertionError("Offline fina_mainbz batch plan"),
                    )
                )
            verified = preparation.verify_manifest(manifest, manifest_sha256)
