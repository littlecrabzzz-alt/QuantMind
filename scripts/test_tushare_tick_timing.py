...
class TickTimingTest(unittest.TestCase):
    def setUp(self):
        ...
        self.stage_values = {
            ...
            "permission_reprobe": {"status": "no_action"},
            "financial_vip_compaction": {"superseded": 11},
        ...
        for method, stage in (
            ...
            ("schedule_permission_reprobes", "permission_reprobe"),
            ("compact_financial_vip_coverage", "financial_vip_compaction"),
    ...
    def test_success_preserves_fields_order_arguments_and_wall_clock(self):
        ...
        self.assertEqual(report["permission_reprobe"], {"status": "no_action"})
        self.assertEqual(report["financial_vip_compaction"], {"superseded": 11})
        ...
        self.assertEqual(timing["total_elapsed_seconds"], 125)
