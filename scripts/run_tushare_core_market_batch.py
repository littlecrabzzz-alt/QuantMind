#!/usr/bin/env python3
"""Plan or execute one hash-pinned core A-share market batch."""
...
from scripts import prepare_tushare_core_market_batch as preparation  # noqa: E402
        ...
        with ExitStack() as guards:
            for target in (
                ...
                guards.enter_context(
                    patch(
                        target,
                        side_effect=AssertionError("Offline core-market batch plan"),
                    )
                )
            verified = preparation.verify_manifest(manifest, manifest_sha256)
