#!/usr/bin/env python3
"""Plan or execute one hash-pinned financial PIT leaf batch."""
...
from scripts import prepare_tushare_financial_pit_batch as preparation  # noqa: E402
...
def _execute(
    ...
    with os.fdopen(descriptor, "a+") as lock:
        ...
        try:
            ...
            pointer_before = sha(_regular(pointer, "current pointer"))
        ...
        with ExitStack() as guards:
            for target in (
                ...
                guards.enter_context(
                    patch(target, side_effect=AssertionError("Offline financial batch plan"))
                )
            verified = preparation.verify_manifest(manifest, manifest_sha256)
        return {
            "schema_version": 1,
