...
第四批在同一未切换固定版下，从停服后的权威队列固定2025-02-23至2025-08-21的沪深各180项；当时仍有25,674个pending，所选360项均为 `pending/tries=0`。46.919秒完成360次调用，得到279 `done`、81 `empty`。清单 SHA256 为 `d81f93c8f81f2059371a984ef6403b3842cf760963142dc58d8d9e9d69ab16bf`，任务集合 SHA256 为 `bbb18733ea84acc339e30ede869f8eb7f202052222ca7f2a24b01f8e9934f4e3`，收据 SHA256 为 `dbc94660abb86a6f34bbea1ebcd748665edd0aeb0ce564b37d6cf18e6ba32d10`。四批累计1,440次请求、805 `done`、635 `empty`；本批同样不发布、不切换 `CURRENT`。
