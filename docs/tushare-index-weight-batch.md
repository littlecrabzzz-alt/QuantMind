...
从固定planner状态离线重建的下一360项覆盖203个已规划指数，沪市246项、CSI 114项；其中326项是尚未采集的6—8月完整月窗，34项是17个饱和指数的拆分子任务。第二批仍有明确的月度扩展价值，但定位为扩大指数和月份覆盖，不能表述为拆分闭包、完整指数宇宙、PIT或研究就绪。若后续增加定制选择，应优先用其他完整月窗替换低边际拆分后代。
