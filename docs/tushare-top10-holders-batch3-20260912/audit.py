#!/usr/bin/env python3
"""Close one exact top10 holders batch from immutable raw and Parquet evidence."""
...
def main() -> None:
    ...
    if (
        ...
        or receipt.get("status") != "top10_holders_exact_batch_executed"
    ...
    inventory = {
        "schema_version": 1,
        "kind": "top10_holders_batch3_exact_refs",
